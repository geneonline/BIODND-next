...
export default function LoginPage() {
  ...
  // useUser handles fetching user profile via cookie-based proxy
            ...
            >
              ...
              <label className="flex flex-col gap-1">
                <div className="flex items-center justify-between">
                  ...
                  {/* 忘記密碼 */}
                  <Link
                    href={{ pathname: "/account/resendPassword", query: { email } }}
                ...
                <div className="relative w-full">
                  <input
                    ...
                    required
                    className="w-full border border-interface-gray-light text-textColor-secondary rounded-10px px-4 py-3.5 text-base focus:border-primary-color-blue focus:ring-0 focus:outline-none pr-12"
                  />
                  <button
                    type="button"
                    aria-label={
