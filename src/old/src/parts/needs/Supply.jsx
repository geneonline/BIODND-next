...
import { useSupplies, useUser } from "@/data/api";
...
const Supply = () => {
  ...
  const { suppliesData, suppliesLoading } = useSupplies();
  const { userData } = useUser();
  const [currentItems, setCurrentItems] = useState(suppliesData || []);
  ...
  useEffect(() => {
    ...
    if (demandSearch.currentTag !== "All Companies") {
      filteredData = suppliesData.filter(
  ...
  return (
    <main className="pt-7.5 pb-15 pl-12 md:pr-10 xl:pr-50">
        ...
        <div className="flex items-center">
          ...
          <div className="relative w-fit">
            <input
              ...
              placeholder={t("connect.supply.placeholder")}
      ...
      <section className="mb-9 flex flex-wrap space-x-2 space-y-2 ">
        ...
        >
          {t("connect.supply.all_companies_tag")}
        </button>
