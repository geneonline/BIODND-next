...
const resolveFieldValue = (field, data) => {
...
const formatObjectEntries = (obj, { displayKeys = true } = {}) => {
...
const getInitialActiveTab = (tabs, defaultTitle) => {
...
const resolveOverlay = (renderLockOverlay, tab, context) => {
  ...
  return (
    <div className="w-full">
      <div className="hidden lg:block">
        <div ref={tabBarRef} className="sticky top-[96px] z-50 bg-white">
        ...
        {renderTable(activeConfig)}
      </div>

      <div className="lg:hidden">
        <div
          ref={tabBarRef}
          className="sticky top-24 scrollbar-hide z-50 bg-white flex border-b border-Gray-500 overflow-x-auto"
        >
          {filteredTabs.map((tab) => (
            <button
              key={tab.title}
